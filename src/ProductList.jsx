...
function ProductList({ onHomeClick }) {
    ...
    const [showPlants, setShowPlants] = useState(true); // Montrer les plantes par défaut
    const dispatch = useDispatch();
    
    // Accéder à l'état du panier depuis Redux store
    ...
    // Fonction pour ajouter un produit au panier avec Redux
    ...
    // Vérifier si une plante est déjà dans le panier
                    ...
                    <div style={{ position: 'relative' }}> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {/* Badge montrant le nombre d'articles dans le panier */}
                                {totalCartQuantity > 0 && (
